        ...
        <section className="relative overflow-hidden py-16 px-4">
          ...
          <div className="relative max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <Badge className="mb-6 bg-orange-500/20 text-orange-400 border-orange-500/30" data-testid="badge-ai-consultant">
                <Bot className="w-3 h-3 mr-1" />
                AI Consultant
              </Badge>
              
              <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4 text-white" data-testid="heading-ai-consultant">
                Train AI on
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <Card className="bg-zinc-900 border-zinc-800 text-center">
                <CardContent className="pt-6">
                  <Brain className="w-10 h-10 text-orange-500 mx-auto mb-3" />
                  <h3 className="font-bold text-white mb-2">Upload Your Content</h3>
              ...
              <Card className="bg-zinc-900 border-zinc-800 text-center">
                <CardContent className="pt-6">
                  <Bot className="w-10 h-10 text-orange-500 mx-auto mb-3" />
                  <h3 className="font-bold text-white mb-2">AI Learns Your Style</h3>
                  <p className="text-sm text-muted-foreground">
              ...
              <Card className="bg-zinc-900 border-zinc-800 text-center">
                <CardContent className="pt-6">
                  <DollarSign className="w-10 h-10 text-orange-500 mx-auto mb-3" />
                  <h3 className="font-bold text-white mb-2">Earn 24/7</h3>
                  <p className="text-sm text-muted-foreground">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              <TabsList className="bg-zinc-900 border border-orange-500/20 mb-8">
                ...
                {mockBots.length === 0 ? (
                  <Card className="bg-zinc-900 border-zinc-800">
                    <CardContent className="py-12 text-center">
                      ...
                      <h3 className="text-xl font-bold text-white mb-2">No AI Consultants Yet</h3>
                        ...
                        <CardContent>
                          <div className="flex flex-wrap gap-2 mb-4">
                            {bot.expertise.map((tag) => (
                              <Badge key={tag} variant="outline" className="text-xs border-orange-500/30 text-orange-400">
                                {tag}
                              </Badge>
                            ))}
                          </div>
                          <div className="grid grid-cols-3 gap-4 text-center">
                            <div>
                              <div className="text-2xl font-bold text-white">{bot.sourceMaterials}</div>
                              <div className="text-xs text-muted-foreground">Sources</div>
                            </div>
                            <div>
                              <div className="text-2xl font-bold text-white">{bot.conversations.toLocaleString()}</div>
                              <div className="text-xs text-muted-foreground">Chats</div>
                            </div>
                            <div>
                              <div className="text-2xl font-bold text-orange-500">${bot.earnings.toLocaleString()}</div>
                  ...
                  <Card className="bg-zinc-900 border-orange-500/30">
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <CardTitle className="text-white">Test {selectedBot.name}</CardTitle>
                        <div className="flex gap-2">
                          ...
                          <Button variant="outline" size="sm" className="border-orange-500/30 gap-1">
              ...
              <TabsContent value="create">
                <Card className="bg-zinc-900 border-zinc-800">
                  <CardHeader>
                    <CardTitle className="text-white">Create New AI Consultant</CardTitle>
                    <CardDescription>
                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-white">Consultant Name</label>
                      <Input
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-white">Training Materials</label>
                      <div className="border-2 border-dashed border-orange-500/30 rounded-lg p-8 text-center">
                        ...
                        <p className="text-white font-medium mb-2">Drag & drop files or click to upload</p>
                    ...
                    {isCreating && (
                      <div className="space-y-2">
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <span className="text-orange-500">{trainingProgress}%</span>
                        </div>
                ...
                <div className="grid md:grid-cols-4 gap-6 mb-8">
                  ...
                  <Card className="bg-zinc-900 border-zinc-800">
                    <CardContent className="pt-6 text-center">
                      ...
                      <div className="text-3xl font-bold text-white">2,139</div>
                  ...
                  <Card className="bg-zinc-900 border-zinc-800">
                    <CardContent className="pt-6 text-center">
                      ...
                      <div className="text-3xl font-bold text-orange-500">$6,417</div>
                ...
                <Card className="bg-zinc-900 border-zinc-800">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-zinc-800 rounded-lg">
                      <div>
                        <h4 className="font-medium text-white">Pay Per Conversation</h4>
                    ...
                    <div className="flex items-center justify-between p-4 bg-zinc-800 rounded-lg">
                      <div>
                        <h4 className="font-medium text-white">Bundle with Course</h4>
                    ...
                    <div className="flex items-center justify-between p-4 bg-zinc-800 rounded-lg">
                      <div>
                        <h4 className="font-medium text-white">Subscription Access</h4>
